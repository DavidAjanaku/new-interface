...
const view = (function () {
  ...
  return {
    ...
    addDragInactive: () => {
      document
        .querySelector(DOMstrings.main_container)
    ...
    addViewFile: (obj) => {
      ...
      let html =
        '<figure class="file" id="file-%id%"><figcaption class="file__name">%fileName%</figcaption><button type="button" class="button" title="delete file"><svg class="button__icon"><use xlink:href="../images/sprite.svg#icon-upload-to-cloud"></use></svg></button></figure>';
...
const ctrl = (function (Model, View) {
  function setUpEventListeners() {
    ...
    document
      .querySelector(DOM.main_container)
      .addEventListener("dragover", addDragActive);
    document
      .querySelector(DOM.main_container)
      .addEventListener("drop", ctrlDropAddItem);
  }
